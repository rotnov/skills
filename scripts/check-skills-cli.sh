...
claude_recorder="$install_root/.claude/skills/active-learning/scripts/recording.py"
codex_recorder="$install_root/.agents/skills/active-learning/scripts/recording.py"
